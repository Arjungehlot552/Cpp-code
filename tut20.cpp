...
1.The main focus is on functions and not on the flow of data
2.Functions can either use local or global data
3.Data moves openly from function to function
